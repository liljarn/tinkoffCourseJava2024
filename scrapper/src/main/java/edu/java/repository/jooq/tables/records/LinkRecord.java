...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, OffsetDateTime, OffsetDateTime, String> {
    ...
    @Override
    @NotNull
    public LinkRecord values(@Nullable Long value1, @Nullable OffsetDateTime value2, @Nullable OffsetDateTime value3, @NotNull String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@Nullable Long linkId, @Nullable OffsetDateTime lastUpdateTime, @Nullable OffsetDateTime checkedAt, @NotNull String url) {
        super(Link.LINK);
